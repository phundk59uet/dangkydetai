...
function pagination($url, $page, $total){
    $adjacents = 2;
    $prevlabel = "&lsaquo; Start";
    $nextlabel = "Next &rsaquo;";
    $out = '<ul class="pagination">';
    
    //first
    if ($page == 1) {
        $out.= '<li class="disabled"><span>Start</span></li>';
    } else {
        $out.='<li><a href="'.$url.'">Start</a></li>';
    }
    ...
    //last
    if ($page < $total) {
        $out.= '<li><a href="'.$url.'&amp;page='.$total.'">End</a></li>';
    } else {
        $out.= '<li class="disabled"><span>End</span></li>';
    }
